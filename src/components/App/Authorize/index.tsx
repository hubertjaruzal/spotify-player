...
const Authorize = (props: Props) => {
  ...
  return (
    <div className={styles.container}>
      <LogoIcon/>
      <a
        href={`https://accounts.spotify.com/en/authorize?client_id=${process.env.REACT_APP_CLIENT_ID}&response_type=code&redirect_uri=${process.env.REACT_APP_REDIRECT_URI}`}
      >
        Sign In
      </a>
    </div>
